...
public class NPBehaveExampleSwarmEnemyAI : MonoBehaviour
{
        ...
        return new Root(ownBlackboard,
            ...
            new Service(0.125f, UpdateBlackboards,
                ...
                new Selector(
                    ...
                    new BlackboardCondition("engaged", Operator.IS_EQUAL, NPValueFactory.Create(true), Stops.IMMEDIATE_RESTART,
                    ...
                    new Selector(
                        ...
                        new BlackboardCondition("playerInRange", Operator.IS_EQUAL, NPValueFactory.Create(true), Stops.BOTH,
    ...
    private void UpdateBlackboards()
    {
        ...
        if (ownBlackboard.Get<bool>("playerInRange") && !ownBlackboard.Get<bool>("engaged") && sharedBlackboard.Get<int>("numEngagedActors") < 2)
        {
            ...
            sharedBlackboard.Set("numEngagedActors", sharedBlackboard.Get<int>("numEngagedActors") + 1);
